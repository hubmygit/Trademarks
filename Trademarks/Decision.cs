...
namespace Trademarks
{
    public partial class Decision : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            NewRecord.StatusId = 2; //apofasi: egkritiki
            NewRecord.DecisionNo = txtDecisionNo.Text;
            NewRecord.DecisionPublDt = dtpPublicationDate.Value.Date;
            ...
            if (isInsert)
            {
                ...
                if (TM_Status.InsertTM_Status_Decision(NewRecord) == false)
                {
                    //TM_Status ins error
                    successful = false;
                }
                ...
                if (successful)
                {
                    if (CreateFinalizationAlarms(givenTM, NewRecord) == false)
                    {
